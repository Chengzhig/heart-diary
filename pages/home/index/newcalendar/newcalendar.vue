		...
		<view  class="myDateTable">
			<view v-for="(item,j) in days" :key="j" class='dateCell'>
				...
				<view v-else>
					...
					<!-- 漏签 -->
					<view @click="clickSignUp(item.date,0)" class="cell redColor bgNONE" 
...
<style>
	...
	.bgFULL{
		background-image: url(../../../../images/5-爱心.png);
		background-repeat: no-repeat;
		background-size: contain;
	}
	.bgLEFTHALF{
		background-image: url(../../../../images/左半爱心.png);
		background-repeat: no-repeat;
		background-size: contain;
	}
	.bgRIGHTHALF{
		background-image: url(../../../../images/右半爱心.png);
		background-repeat: no-repeat;
		background-size: contain;
	}
	.bgNONE{
		background-image: url(../../../../images/空爱心.png);
		background-repeat: no-repeat;
		background-size: contain;
	}
	.redColor {
